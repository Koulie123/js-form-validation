...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,4BAA4B;EAC5B,YAAY;AACd;AACA;EACE,qBAAqB;AACvB","sourcesContent":["fieldset {\n  display: grid;\n  grid-template-columns: fr fr;\n  width: 20rem;\n}\ninput:invalid {\n  border: 2px solid red;\n}"],"sourceRoot":""}]);
// Exports
